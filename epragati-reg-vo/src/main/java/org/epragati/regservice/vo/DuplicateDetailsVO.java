...
public class DuplicateDetailsVO {
	...
	/**
	 * @param chooseReason the chooseReason to set
	 */
	...
	/**
	 * @param remarksForReason the remarksForReason to set
	 */
	...
	/**
	 * @param firNumber the firNumber to set
	 */
