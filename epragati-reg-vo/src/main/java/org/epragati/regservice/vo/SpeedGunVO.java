...
public class SpeedGunVO {
	...
	@JsonProperty("GUN_DATE")
	private String gunDate;
	@JsonProperty("GUN_TIME")
	private String gunTime;
	@JsonProperty("SPEED_ZONE")
	...
	@JsonProperty("VCR_GEN_DT")
	private String vcrGenDt; 
	@JsonProperty("MOBILE_NO")
	private String mobileNo;
	@JsonProperty("SMS_FLAG")
	private String smsFlag;
	@JsonProperty("SMS_SEND_DT")
	private String smsSendDt; 
	@JsonProperty("VCRGEN_SMS_DT")
	private String vcrgenSmsDt;
	@JsonProperty("VCRGENSMS_FLAG")
	private String vcrgenSmsFlag;
	@JsonProperty("OVERSPEED_OFFENCES")
	 ...
	 * @return the vcrGenDt
	 */
	public String getVcrGenDt() {
		return vcrGenDt;
	}
	/**
	 * @param vcrGenDt the vcrGenDt to set
	 */
	public void setVcrGenDt(String vcrGenDt) {
