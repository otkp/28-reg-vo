...
public class VahanDetailsVO implements Serializable {
   ...
   private String pollutionNormsDesc;
	...
	private HarvestersDetailsVO harvestersDetails;
	...
	private Integer oldGvw;
      	...
      	/**
      	 * @param makersName the makersName to set
      	 */
	...
	*//**
	...
	/**
	 * @param insurancePolicyNumber the insurancePolicyNumber to set
	 */
	...
	/**
	 * @param insuranceUpto the insuranceUpto to set
	 */
	...
	/**
	 * @param sleeperCapacity the sleeperCapacity to set
	 */
	...
	/**
	 * @param standCapacity the standCapacity to set
	 */
	...
	/**
	 * @param statusAsOn the statusAsOn to set
	 */
	...
	/**
	 * @param o2AxleDesc the o2AxleDesc to set
	 */
	...
	/**
	 * @param o2AxleWeight the o2AxleWeight to set
	 */
	...
	/**
	 * @param o3AxleDesc the o3AxleDesc to set
	 */
	...
	/**
	 * @param o3AxleWeight the o3AxleWeight to set
	 */
	...
	/**
	 * @param o4AxleDesc the o4AxleDesc to set
	 */
	...
	/**
	 * @param o4AxleWeight the o4AxleWeight to set
	 */
	...
	/**
	 * @param o5AxleDesc the o5AxleDesc to set
	 */
	...
	/**
	 * @param o5AxleWeight the o5AxleWeight to set
	 */
	...
	/**
	 * @param dealerSelectedMakerName the dealerSelectedMakerName to set
	 */
	...
	/**
	 * @param dealerSelectedMakerClass the dealerSelectedMakerClass to set
	 */
	...
	/**
	 * @param dealerSelectedBodyType the dealerSelectedBodyType to set
	 */
	...
	public String toString() {
		return "VahanDetailsVO [registrationNumber=" + registrationNumber + ", chassisNumber=" + chassisNumber
				+ ", engineNumber=" + engineNumber + ", ownerName=" + ownerName + ", name=" + name + ", model=" + model
				+ ", color=" + color + ", manufacturedMonthYear="
				+ manufacturedMonthYear + ", vehicleClass=" + vehicleClass + ", makersModel=" + makersModel
				+ ", seatingCapacity=" + seatingCapacity + ", statusMessage=" + statusMessage + ", registrationDate="
				+ registrationDate + ", ownerSr=" + ownerSr + ", firstName=" + firstName + ", presentAddress="
				+ presentAddress + ", bodyTypeDesc=" + bodyTypeDesc + ", fitUpto=" + fitUpto + ", taxUpto=" + taxUpto
				+ ", financer=" + financer + ", insuranceCompany=" + insuranceCompany + ", insurancePolicyNumber="
				+ insurancePolicyNumber + ", insuranceUpto=" + insuranceUpto + ", noCyl=" + noCyl + ", cubicCapacity="
				+ cubicCapacity + ", sleeperCapacity=" + sleeperCapacity + ", standCapacity=" + standCapacity
				+ ", registeredAt=" + registeredAt + ", statusAsOn=" + statusAsOn + ", exShowroomPrice="
				+ exShowroomPrice + ", isUsed=" + isUsed + ", enginePower=" + enginePower + ", frontAxleDesc="
				+ frontAxleDesc + ", frontAxleWeight=" + frontAxleWeight + ", fuelDesc=" + fuelDesc + ", gvw=" + gvw
				+ ", height=" + height + ", length=" + length + ", makersDesc=" + makersDesc + ", id=" + id
				+ ", pollutionNormsDesc=" + pollutionNormsDesc + ", o1AxleDesc=" + o1AxleDesc + ", o1AxleWeight="
				+ o1AxleWeight + ", o2AxleDesc=" + o2AxleDesc + ", o2AxleWeight=" + o2AxleWeight + ", o3AxleDesc="
				+ o3AxleDesc + ", o3AxleWeight=" + o3AxleWeight + ", o4AxleDesc=" + o4AxleDesc + ", o4AxleWeight="
				+ o4AxleWeight + ", o5AxleDesc=" + o5AxleDesc + ", o5AxleWeight=" + o5AxleWeight + ", rearAxleDesc="
				+ rearAxleDesc + ", rearAxleWeight=" + rearAxleWeight + ", unladenWeight=" + unladenWeight
				+ ", wheelbase=" + wheelbase + ", width=" + width + "]";
	}
	...
	/**
	 * @param isNonVahanData the isNonVahanData to set
	 */
	 ...
	 */
	public HarvestersDetailsVO getHarvestersDetails() {
		return harvestersDetails;
	}
	/**
	 * @param harvestersDetails the harvestersDetails to set
	 */
	public void setHarvestersDetails(HarvestersDetailsVO harvestersDetails) {
