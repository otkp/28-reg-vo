...
public class DriverDetailsVcrVo implements Serializable {
	...
	private List<MasterCovVO> classsOfVehicle;
	//@NotNull(message = "classsOfVehicle are required.")L̥
	//private MasterCovVO classsOfVehicle;
	@JsonFormat(pattern = "yyyy-MM-dd")
	private LocalDate issuedBy;
	public List<MasterCovVO> getClasssOfVehicle() {
		return classsOfVehicle;
	}

	public void setClasssOfVehicle(List<MasterCovVO> classsOfVehicle) {
	...
	private VcrGoodsVO goodsDescription;
	...
	/*
	 * public List<MasterCovVO> getClasssOfVehicle() { return classsOfVehicle; }
	 * 
	 * public void setClasssOfVehicle(List<MasterCovVO> classsOfVehicle) {
	 * this.classsOfVehicle = classsOfVehicle; }
	 */
	...
	public VcrGoodsVO getGoodsDescription() {
		return goodsDescription;
	}

	public void setGoodsDescription(VcrGoodsVO goodsDescription) {
