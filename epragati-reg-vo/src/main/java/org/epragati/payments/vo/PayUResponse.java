...
public class PayUResponse {
	...
	/**
	 * @param payuMoneyId the payuMoneyId to set
	 */
	...
	public String toString() {
		return "PayUResponse [" + (key != null ? "key=" + key + ", " : "")
				+ (mihpayid != null ? "mihpayid=" + mihpayid + ", " : "")
				+ (status != null ? "status=" + status + ", " : "")
				+ (bank_ref_num != null ? "bank_ref_num=" + bank_ref_num + ", " : "")
				+ (request_id != null ? "request_id=" + request_id + ", " : "")
				+ (amt != null ? "amt=" + amt + ", " : "") + (amount != null ? "amount=" + amount + ", " : "")
				+ (cardCategory != null ? "cardCategory=" + cardCategory + ", " : "")
				+ (discount != null ? "discount=" + discount + ", " : "")
				+ (transaction_amount != null ? "transaction_amount=" + transaction_amount + ", " : "")
				+ (txnid != null ? "txnid=" + txnid + ", " : "")
				+ (additional_charges != null ? "additional_charges=" + additional_charges + ", " : "")
				...
				+ (bankcode != null ? "bankcode=" + bankcode + ", " : "") + (udf1 != null ? "udf1=" + udf1 + ", " : "")
				+ (udf2 != null ? "udf2=" + udf2 + ", " : "") + (udf3 != null ? "udf3=" + udf3 + ", " : "")
				+ (udf4 != null ? "udf4=" + udf4 + ", " : "") + (udf5 != null ? "udf5=" + udf5 + ", " : "")
				+ (udf6 != null ? "udf6=" + udf6 + ", " : "") + (udf7 != null ? "udf7=" + udf7 + ", " : "")
				+ (udf8 != null ? "udf8=" + udf8 + ", " : "") + (udf9 != null ? "udf9=" + udf9 + ", " : "")
				+ (udf10 != null ? "udf10=" + udf10 + ", " : "") + (field1 != null ? "field1=" + field1 + ", " : "")
				+ (field2 != null ? "field2=" + field2 + ", " : "") + (field3 != null ? "field3=" + field3 + ", " : "")
				+ (field4 != null ? "field4=" + field4 + ", " : "") + (field5 != null ? "field5=" + field5 + ", " : "")
				+ (field6 != null ? "field6=" + field6 + ", " : "") + (field7 != null ? "field7=" + field7 + ", " : "")
				+ (field8 != null ? "field8=" + field8 + ", " : "") + (field9 != null ? "field9=" + field9 + ", " : "")
				+ (card_type != null ? "card_type=" + card_type + ", " : "")
				+ (error != null ? "error=" + error + ", " : "")
				+ (error_code != null ? "error_code=" + error_code + ", " : "")
				+ (error_Message != null ? "error_Message=" + error_Message + ", " : "")
				+ (net_amount_debit != null ? "net_amount_debit=" + net_amount_debit + ", " : "")
				+ (disc != null ? "disc=" + disc + ", " : "") + (mode != null ? "mode=" + mode + ", " : "")
				+ (pgTYPE != null ? "pgTYPE=" + pgTYPE + ", " : "")
				+ (card_no != null ? "card_no=" + card_no + ", " : "")
				+ (name_on_card != null ? "name_on_card=" + name_on_card + ", " : "")
				+ (addedon != null ? "addedon=" + addedon + ", " : "")
				+ (unmappedstatus != null ? "unmappedstatus=" + unmappedstatus + ", " : "")
				+ (Merchant_UTR != null ? "Merchant_UTR=" + Merchant_UTR + ", " : "")
				+ (Settled_At != null ? "Settled_At=" + Settled_At + ", " : "")
				+ (payment_source != null ? "payment_source=" + payment_source + ", " : "")
				+ (cardnum != null ? "cardnum=" + cardnum + ", " : "")
				+ (cardhash != null ? "cardhash=" + cardhash + ", " : "") + (hash != null ? "hash=" + hash + ", " : "")
				+ (payuMoneyId != null ? "payuMoneyId=" + payuMoneyId + ", " : "")
				+ (properties != null ? "properties=" + properties + ", " : "")
				+ (additionalCharges != null ? "additionalCharges=" + additionalCharges : "") + "]";
	}
